      ...
      >
        ...
        <div className="container mx-auto text-center space-y-8 relative z-10">
          ...
          <p className="bg-black/30 p-4 text-xl md:text-2xl text-white max-w-4xl mx-auto leading-relaxed rounded-lg">
            We're building the future of healthcare by connecting patients with
            exceptional medical professionals through innovative technology and
            compassionate care.
          </p>
        </div>
      </section>
      ...
      <main className="container mx-auto py-16 px-4 space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <Card className="border-none shadow-lg bg-gradient-to-br from-brandBlue/5 to-brandBlue/10">
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-2xl text-brandBlue">
                Our Mission
              </CardTitle>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-muted-foreground text-lg leading-relaxed">
                To democratize healthcare access by creating an intuitive
                platform that empowers patients to easily connect with qualified
                healthcare professionals, ensuring timely and quality medical
                care for everyone.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-none shadow-lg bg-gradient-to-br from-emerald-500/5 to-emerald-500/10">
            ...
            <CardContent className="text-center">
              <p className="text-muted-foreground text-lg leading-relaxed">
                A world where healthcare is seamlessly accessible, personalized,
                and proactive. We envision a healthcare ecosystem where
                technology bridges the gap between patients and providers,
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="text-center">
                <p className="text-muted-foreground">
                  ...
                  healthcare decisions are deeply personal and important.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="text-center">
                <p className="text-muted-foreground">
                  Your health information deserves the highest level of
                  protection. We maintain strict security standards and privacy
                  protocols.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="text-center">
                <p className="text-muted-foreground">
                  ...
                  technology to provide the best possible healthcare experience.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <section>
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Experience healthcare booking reimagined
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Schedule appointments with just a few clicks, anytime,
                    anywhere.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Connect with licensed and experienced doctors across all
                    specialties.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Rigorous standards ensure you receive the best possible
                    care.
                  </p>
                </div>
              </div>
        ...
        <section className="bg-gradient-to-r from-brandBlue to-primary rounded-2xl p-8 md:p-12 text-center text-white">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            ...
            experience with Care Point.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="shadow-lg cursor-pointer bg-brandBlue hover:bg-brandBlue/90 text-white"
              onClick={() => {
                if (token) {
                  navigate("/doctor");
                } else {
            ...
            <Button
              size="lg"
              className="border-white text-brandBlue bg-white hover:bg-gray-100 cursor-pointer shadow-lg"
            >
              Contact Us
            </Button>
          </div>
